...
from pygame.locals import SRCALPHA, SCRAP_TEXT, SCRAP_CLIPBOARD# pylint: disable=no-name-in-module
from pygame.surface import Surface# pylint: disable=no-name-in-module
from pygame import draw, font, cursors, mouse, scrap
...
class OutlinedBox(ClientSprite):
    ...
    def __init__(self, dims: tuple, *groups, outline: tuple=(0, 0, 0),
                 color: tuple=(0xff, 0xff, 0xff),
                 border_radius: int=15, border_width: int=3):
    ...
    def reset_image(self, width: int=None, height: int=None) -> None:
        ...
        draw.rect(self.image, self.color, blit_rect,
                  border_radius=self.border_radius)
        if self.color != self.outline and self.border_width:
            draw.rect(self.image, self.outline, blit_rect,
...
class Button(OutlinedBox):
    ...
    __slots__ = ('action',)
    # pylint: disable=too-many-arguments
    def __init__(self, dims: tuple, *groups, action: Callable=None,
                 outline: tuple=(0, 0, 0),
                 color: tuple=(0xff, 0xff, 0xff),
                 border_radius: int=15, border_width: int=3):
        super().__init__(dims, *groups, outline=outline, color=color,
...
class Label(OutlinedBox):
    ...
    def __init__(self, font_path: str, text_size: int, text: str, *groups,
        ...
        super().__init__((None, None), *groups, outline=outline,
                       color=button_color, border_radius=border_radius,
                       border_width=border_width)
        self.text = text
...
class TextButton(Button):
    ...
    __slots__ = ('__text', 'text_color', 'font')
    def __init__(self, font_path: str, text_size: int, text: str, *groups,
                 action: Callable=None, text_color: tuple=(0, 0, 0),
                 outline: tuple=(0, 0, 0),
                 button_color: tuple=(0xff, 0xff, 0xff),
                 border_radius: int=15, border_width: int=3):
        self.__text = None
        ...
        super().__init__((None, None), *groups, action=action, outline=outline,
                       color=button_color, border_radius=border_radius,
                       border_width=border_width)
        self.text = text
